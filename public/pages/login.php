...
// Render form inputs
$type = 'text'; $id = 'username'; $label = 'Username'; $aria_label = 'Inserisci il tuo username';
ob_start(); include __DIR__ . '/../includes/form-input.php'; $form_input_username = ob_get_clean();

$type = 'password'; $id = 'password'; $label = 'Password'; $aria_label = 'Inserisci la tua password';
ob_start(); include __DIR__ . '/../includes/form-input.php'; $form_input_password = ob_get_clean();
