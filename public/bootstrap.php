...
header(
    ...
    . "script-src 'self'; "
    . "connect-src 'self' https://www.googleapis.com https://archive.org https://api.isbndb.com https://api.bookshare.org https://bookshare.org https://www.bookshare.org; "
    . "img-src 'self' https://covers.openlibrary.org https://books.google.com https://*.googleusercontent.com https://archive.org https://*.archive.org; "
    . "font-src 'self'; "
    . "frame-src 'self'; "
    . "object-src 'none'; "
    . "base-uri 'self';"
